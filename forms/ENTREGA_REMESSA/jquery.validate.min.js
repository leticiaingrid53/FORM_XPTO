...
/**
 * Método customizado para validar Data no formato brasileiro
 * Origem do método customizado: https://gist.github.com/diasfulvio/6059199
 */
 ...
 */
var listaErros = function() {
	var lstHtml = '</br>';
	$.each($validator.errorList, function (id, campo) {
		
		var name = campo.element.name;
		if(name.indexOf("___") >= 0){
			name = name.substr(0,name.indexOf("___"));
		}
...
/**
 * Opções comuns dentre todas as validações de campos
 */	
